...
#if a list has 10 elements it is like a trian with 10 cars
#if we want to work with the contents of car #5 we use [[5]]
#[5] gives you a train with just car 5
#[c(4,5,6)] gives you just a little train with cars 4,5,6
...
myList2$littleM[2,3] #get row 2, columns

myList2$littleM

myList2$littleM[2,] #show second row, all columns
myList2$littleM[2] #what does this give? 
myList2$littleM[5]

#The "unlist" strings everythihng back into a single atomic vector; coercion is used if there are mixed data types
...
#data frames are lists of equal length atomic vectors, each of which is a column
...
#see notes on dataframes from feb 13 lecture
